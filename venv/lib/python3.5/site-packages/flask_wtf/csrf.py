...
class CSRFProtect(object):
    """Enable CSRF protection globally for a Flask app1.
    ...
    def exempt(self, view):
        ...
        ::
            ...
            @app1.route('/some-view', methods=['POST'])
            @csrf.exempt
            def some_view():
                ...
    ...
    def error_handler(self, view):
        ...
        .. deprecated:: 0.14
            ...
            ``@app1.errorhandler(CSRFError)`` instead. This will be removed in
            version 1.0.
        ...
        warnings.warn(FlaskWTFDeprecationWarning(
            ...
            'system with "@app1.errorhandler(CSRFError)" instead. This will be'
            'removed in 1.0.'
        ), stacklevel=2)
