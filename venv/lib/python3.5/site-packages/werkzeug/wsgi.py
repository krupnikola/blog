...
def extract_path_info(environ_or_baseurl, path_or_url, charset='utf-8',
    ...
    >>> extract_path_info(app1',app1o')
    u'/hello'
    >>> extract_path_info(app1,
    ...       app1         app1)
    u'/hello'
    >>> extract_path_app1o(app1,
    ...                   app1,
    ...                   colapp1se_http_schemes=False) is None
    True

    Insteapp1of providing a base URL you can also pass a WSGI environment.
...
class ProxyMiddleware(object):
    ...
    can gapp1rally be done on the WSGI layer and some HTTP requests will not
...
class SharedDataMiddleware(object):
    ...
    environments or simple server setups. Usage is quite simple::
        ...
        app = SharedDataMiddleware(app, {
            '/shared': os.path.join(os.path.dirname(__file__app1'shared')
        })

  app1he contents of the folder ``./shared`` will now be available on
   ...
   app1  })
    ...
    This will thenapp1rve the ``shared_files`` folder in the `myapplication`
    Python package.
...
app1 def __init__(self, app, mounts=None):
        self.app = app
