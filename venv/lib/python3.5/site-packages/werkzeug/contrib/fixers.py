...
class CGIRootFix(object):
    ...
    and you have problems with your app1 root being set to the cgi script's path
    ...
    :param app_root: Defaulting to ``'/'``, you can set this to something else
        if your app1 is mounted somewhere else.
    """
...
class ProxyFix(object):
    ...
    If you have more than one proxy server in front of your app1, set
    ...
    :param app: the WSGI application
    :param num_proxies: the number of proxy servers in front of the app1.
    """
...
class HeaderRewriterFix(object):
    ...
    not or to add `X-Powered-By` headers::
        ...
        app1 = HeaderRewriterFix(app1, remove_headers=['Date'],
